...
<table id="listeSousCatalogue" class="table table-bordered">
    <thead>
        <tr>
            <th>ID</th>
            ...
            foreach($assoc as $ligneTab) {
				...
				echo '<td width="18%">
					<form method="get" action="" style="float:left;margin-right:5px;">
						<input type="hidden" value="'.$ligneTab['ID_souscatalogue'].'" name="idsouscat"/>
						<input type="submit" value="Modifier" class="btn btn-primary"/>
					</form>
					<form method="post" action="">
						<input type="hidden" value="'.$ligneTab['ID_souscatalogue'].'" name="supprSousCat"/>
...
<?php
	...
	if(isset($_POST['supprSousCat'])) {
		$bdd6 = bdd();
		$bdd6->exec("DELETE FROM souscatalogue WHERE ID_souscatalogue='".$_POST['supprSousCat']."'");
